...
async def quality_flags_from_csv(file: UploadFile = File(...)) -> Dict[str, Any]:
    ...
    # Создаем ответ с только булевыми флагами
    response_flags = {
        ...
        "has_constant_columns": bool(flags_all.get("has_constant_columns", False)),
        "has_high_cardinality_categoricals": bool(flags_all.get("has_high_cardinality_categoricals", False)),
    }
